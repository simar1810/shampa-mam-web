      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="h-full min-h-[340px] flex flex-col justify-between bg-gradient-to-br from-[#d1f1e6] to-[#a7e9cd] text-gray-900 border-none shadow-lg rounded-2xl p-8 items-center text-center hover:scale-[1.02] transition duration-300">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="h-full min-h-[340px] flex flex-col justify-between bg-gradient-to-br from-[#ffe5ec] to-[#ffc7d9] text-gray-900 border-none shadow-lg rounded-2xl p-8 items-center text-center hover:scale-[1.02] transition duration-300">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="h-full min-h-[340px] flex flex-col justify-between bg-gradient-to-br from-[#fff3d1] to-[#ffe3aa] text-gray-900 border-none shadow-lg rounded-2xl p-8 items-center text-center hover:scale-[1.02] transition duration-300">
              <svg
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="h-full min-h-[340px] flex flex-col justify-between bg-gradient-to-br from-[#ffd4c4] to-[#ffb69e] text-gray-900 border-none shadow-lg rounded-2xl p-8 items-center text-center hover:scale-[1.02] transition duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-sm text-gray-700">
                We focus on your emotional and physical health—not just
                weight—for lasting transformation.
              </p>
            </Card>
          </motion.div>
        </div>
